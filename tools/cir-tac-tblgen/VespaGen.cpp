...
inline static std::map<llvm::StringRef, llvm::StringRef> cppTypeToSerializer = {
    ...
    {"mlir::FlatSymbolRefAttr",
     "attributeSerializer.serializeMLIRFlatSymbolRefAttr"},
...
inline static std::map<llvm::StringRef, const char *const>
    cppTypeToDeserializerCall = {
        ...
        {"mlir::Attribute",
         "AttrDeserializer::deserializeMLIRAttribute(mInfo, {0})"},
        {"mlir::TypedAttr",
         "AttrDeserializer::deserializeMLIRAttribute(mInfo, {0})"},
        ...
        {"StringAttr",
         "AttrDeserializer::deserializeMLIRStringAttr(mInfo, {0})"},
        {"mlir::StringAttr",
         "AttrDeserializer::deserializeMLIRStringAttr(mInfo, {0})"},

        {"mlir::ArrayAttr",
         "AttrDeserializer::deserializeMLIRArrayAttr(mInfo, {0})"},
        {"mlir::IntegerAttr",
         "AttrDeserializer::deserializeMLIRIntegerAttr(mInfo, {0})"},
        {"mlir::DictionaryAttr",
         "AttrDeserializer::deserializeMLIRDictionaryAttr(mInfo, {0})"},
        {"mlir::TypeAttr",
         "AttrDeserializer::deserializeMLIRTypeAttr(mInfo, {0})"},
        {"mlir::FlatSymbolRefAttr",
         "AttrDeserializer::deserializeMLIRFlatSymbolRefAttr(mInfo, {0})"},
        {"std::optional<mlir::FlatSymbolRefAttr>",
         "AttrDeserializer::deserializeMLIRFlatSymbolRefAttr(mInfo, {0})"},
        {"mlir::UnitAttr",
         "AttrDeserializer::deserializeMLIRUnitAttr(mInfo, {0})"},

        {"NamedAttribute",
         "AttrDeserializer::deserializeMLIRNamedAttr(mInfo, {0})"},

        {"Location", "AttrDeserializer::deserializeMLIRLocation(mInfo, {0})"},

        {"cir::GlobalViewAttr",
         "AttrDeserializer::deserializeCIRGlobalViewAttr(mInfo, {0})"},
        {"cir::IntAttr", "AttrDeserializer::deserializeCIRIntAttr(mInfo, {0})"},

        {"SignednessSemantics",
         "EnumDeserializer::deserializeMLIRSignednessSemantics({0})"},
        {"CmpOrdering", "EnumDeserializer::deserializeCIRCmpOrdering({0})"},
        {"InlineKind", "EnumDeserializer::deserializeCIRInlineKind({0})"},
        {"VisibilityKind",
         "EnumDeserializer::deserializeCIRVisibilityKind({0})"},
        {"sob::SignedOverflowBehavior",
         "EnumDeserializer::deserializeCIRSignedOverflowBehavior({0})"},

        {"SourceLanguageAttr",
         "EnumDeserializer::deserializeCIRSourceLanguage({0})"},

        {"cir::AtomicFetchKind",
         "EnumDeserializer::deserializeCIRAtomicFetchKind({0})"},
        ...
        {"cir::BinOpOverflowKind",
         "EnumDeserializer::deserializeCIRBinOpOverflowKind({0})"},
        {"cir::CallingConv",
         "EnumDeserializer::deserializeCIRCallingConv({0})"},
        {"cir::CaseOpKind", "EnumDeserializer::deserializeCIRCaseOpKind({0})"},
        {"cir::CastKind", "EnumDeserializer::deserializeCIRCastKind({0})"},
        {"cir::CatchParamKind",
         "EnumDeserializer::deserializeCIRCatchParamKind({0})"},
        {"cir::CmpOpKind", "EnumDeserializer::deserializeCIRCmpOpKind({0})"},
        {"cir::CmpOrdering",
         "EnumDeserializer::deserializeCIRCmpOrdering({0})"},
        {"cir::ComplexBinOpKind",
         "EnumDeserializer::deserializeCIRComplexBinOpKind({0})"},
        {"cir::ComplexRangeKind",
         "EnumDeserializer::deserializeCIRComplexRangeKind({0})"},
        {"cir::DynamicCastKind",
         "EnumDeserializer::deserializeCIRDynamicCastKind({0})"},
        {"cir::GlobalLinkageKind",
         "EnumDeserializer::deserializeCIRGlobalLinkageKind({0})"},
        ...
        {"cir::sob::SignedOverflowBehavior",
         "EnumDeserializer::deserializeCIRSignedOverflowBehavior({0})"},
        {"cir::SizeInfoType",
         "EnumDeserializer::deserializeCIRSizeInfoType({0})"},
        {"cir::SourceLanguage",
         "EnumDeserializer::deserializeCIRSourceLanguage({0})"},
        {"cir::TLS_Model", "EnumDeserializer::deserializeCIRTLSModel({0})"},
        {"cir::UnaryOpKind",
         "EnumDeserializer::deserializeCIRUnaryOpKind({0})"},
        {"cir::VisibilityKind",
         "EnumDeserializer::deserializeCIRVisibilityKind({0})"},
        {"cir::StructType::RecordKind",
         "EnumDeserializer::deserializeCIRRecordKind({0})"},
        {"mlir::IntegerType::SignednessSemantics",
         "EnumDeserializer::deserializeMLIRSignednessSemantics({0})"},
...
void vespa::serializeParameter(mlir::tblgen::AttrOrTypeParameter &p,
  ...
  if (type.starts_with("llvm::ArrayRef") || type.starts_with("ArrayRef")) {
    ...
    // hotfix
    if (varName == "attr" &&
        llvm::StringRef(i).starts_with("attributeSerializer")) {
  ...
  // hotfix
  if (varName == "attr" &&
      llvm::StringRef(field).starts_with("attributeSerializer")) {
...
std::string deserializeElement(const ParamData &p, llvm::StringRef varName) {
  auto typ = p.cppType;
  ...
  if (typ.ends_with("Attr")) {
    ...
    std::string protoName =
        ((namePair.first == "cir" ? "CIR" : "MLIR") + namePair.second).str();
    return "AttrDeserializer::deserialize" + protoName + "(mInfo, " +
           varName.str() + ")";
  }
...
std::string deserializeOptional(const ParamData &p, llvm::StringRef varName,
...
if ({1}.has_{3}()) {{
  ...
  return formatv(deserializerBody, typ, varName, deserName, fieldName, elDeser)
      .str();
}

std::string deserializeArray(const ParamData &p, llvm::StringRef varName,
                             llvm::StringRef deserName, std::string fieldName) {
  const char *const deserializerBody = R"(
std::vector<{0}> {2};
...
std::string deserializeVarOfVar(const ParamData &p, llvm::StringRef varName,
                                llvm::StringRef deserName,
                                std::string fieldName) {
...
for (auto j = 0; j < {1}.{3}_size(); j++) {{)";
  ...
  auto innerDeser = deserializeArray(p, innerFieldVar, innerArrayName, "list");
  ...
  os << formatv(deserializerBodyStart, outerVectorType, varName, deserName,
                fieldName, innerArrayName)
            .str();
  os.indent();
